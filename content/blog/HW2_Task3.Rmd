...
**Figure 1. Land Use Land Cover Types on Oahu.** Location of bays and estuaries, commercial, evergreen forest, and residential land use/land cover (LULC) types based on historical LULC classification data as of 1976. Data accessed at: http://geoportal.hawaii.gov/datasets/land-use-land-cover-lulc?geometry=-165.822%2C18.755%2C-149.134%2C22.354
</p>
...
```
<p style="font-size:0.9em; font-style:italic; color: grey">
**Figure 2. Oahu's Watersheds.** Top 10 largest watersheds of Oahu layered over ESRI World Topomap. Area of watersheds are measured in square meters as calculated by the GIS. Data accessed at: http://geoportal.hawaii.gov/datasets/watersheds?geometry=-165.822%2C18.755%2C-149.134%2C22.354
</p>
