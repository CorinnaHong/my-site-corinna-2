...
Yield in all four crops rapidly increased after the 1950s. All four of these growth trends can best be described  described by a linear, low plateau (LLP) model. The overall hockeystick shape of the trend is a plateau in yield until about 1945, where it begins to increase linearly into the 2000s. The trend in Sorghum's yield also looks like it has an upper plateau. There is a plateau from 1925 to around 1945. After that, sorghum experiences a linear increase until around 1980 where it plateaus again.
...
```{r, fig.align = "center", fig.cap = "**Corn Case Study.** U.S. Corn Yield measured in bushels per acre from three different classes of fertilizers from 1964-2016. Three classes of fertilizers are shown: Nitrogen, phosphate, and potassium. Data points are color coded based on year with lighter blues indicating more recent years. Data accessed at: https://www.ers.usda.gov/data-products/fertilizer-use-and-price/"}
